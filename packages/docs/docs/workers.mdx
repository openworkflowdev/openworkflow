...
Workers can also clean up old terminal workflow runs automatically. Configure
this in `openworkflow.config.ts`:
...
With this enabled, workers periodically delete terminal workflow runs older than
