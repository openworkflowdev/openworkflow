...
<Files>
  <Folder name="/" defaultOpen>
    ...
    <Folder name="docker">
      <File name="Dockerfile.worker" />
      <File name="Dockerfile.app" />
    </Folder>
...
<Callout type="error" title="Critical: Never Commit Secrets">
...
<Accordion title="High Database Load">
