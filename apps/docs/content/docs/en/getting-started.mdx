...
<Cards>
  ...
  <Card
    ...
    href="/en/docs/advanced-features#type-safety"
  />
  <Card
    title="Parallel Execution"
    description="Run multiple steps concurrently with Promise.all"
    href="/en/docs/advanced-features#parallel-steps"
  />
  <Card
...
- [Core Concepts](/en/docs/core-concepts) - Deep dive into workflows, steps, and workers
- [Architecture](/en/docs/architecture) - Understand the execution model
- [API Reference](/en/docs/api-reference) - Complete API documentation