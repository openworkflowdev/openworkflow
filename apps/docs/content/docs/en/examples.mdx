...
<Callout type="info" title="E-commerce Best Practices">
...
<Callout type="warn" title="Error Handling Patterns">
...
<Callout type="success" title="Saga Pattern">
...
<Callout title="Testing Strategy">
...
<Files>
  <Folder name="tests" defaultOpen>
    <Folder name="unit">
      <File name="email-service.test.ts" />
      <File name="payment-service.test.ts" />
    </Folder>
    <Folder name="integration">
      <File name="send-welcome-email.test.ts" />
      <File name="process-order.test.ts" />
    </Folder>
    <Folder name="e2e">
      <File name="complete-order-flow.test.ts" />
    </Folder>
  </Folder>
</Files>
