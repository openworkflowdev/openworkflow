---
title: Sentry
description: View workflow traces in Sentry with OpenTelemetry to see which steps ran, how long they took, and where they failed
---
...
![OpenWorkflow trace in Sentry](/assets/sentry.png)
