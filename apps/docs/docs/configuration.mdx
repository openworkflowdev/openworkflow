---
title: Configuration
description: openworkflow.config.ts reference for database connections, workflow file discovery, and worker concurrency settings
---
...
If you ran `npx @openworkflow/cli init`, this file was created for you.
