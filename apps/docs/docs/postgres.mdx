...
description: PostgreSQL storage for production deployments with multiple workers, including connection setup and migrations
---

The PostgreSQL backend is recommended for production deployments with multiple
concurrent workers.
