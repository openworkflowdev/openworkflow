---
title: Production
description: Run OpenWorkflow in your own infrastructure with workers that connect directly to your PostgreSQL or SQLite database
---
...
database, so you don't deploy or operate a separate orchestration service.
...
`OPENWORKFLOW_POSTGRES_URL`, `OPENWORKFLOW_NAMESPACE_ID`, and
`OPENWORKFLOW_SCHEMA` set the Postgres URL, namespace, and schema.
