---
title: Steps
description: Durable checkpoints that don't repeat already completed work, saving step results for retries and crash recovery
---
...
Steps act as checkpoints that prevent your operations from being accidentally
repeated.
