---
title: Overview
description: How OpenWorkflow works and how Workflows, Steps, and Workers fit together to save progress and recover after a crash
---
...
- **Steps**: durable checkpoints that save results for reuse on replay
...
- **Memoized steps** replay durably recorded results without rerunning those
  step functions
