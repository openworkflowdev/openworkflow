...
<CardGroup cols={2}>
  ...
  <Card title="CLI Reference" icon="terminal" href="/docs/cli">
    Set up your project, start workers, and open the dashboard.
  </Card>
  <Card title="Building with LLMs" icon="robot" href="/docs/llms">
    Use agent skills, Markdown docs, and MCP search with your coding assistant.
  </Card>
</CardGroup>
